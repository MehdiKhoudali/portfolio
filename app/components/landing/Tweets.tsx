    ...
    return (
        ...
        <section className="p-4 md:flex gap-8 md:p-8">
            ...
            <div className="mb-4 p-8 flex flex-col gap-8 rounded-md bg-[#1e1f24]">
                ...
                <h1 className="font-bold text-2xl">Learn more about SaaS and tech on my Newsletter !</h1>
                <p className="text-gray-500">I'm sharing every week tips about SaaS, business, tech, programming.</p>
                <button className="bg-purple-800 p-2 md:p-4 rounded-md items-center text-center"><a href="https://twitter.com/mehdi_khoudali">Join my newsletter</a></button>
            </div>
        </section>
